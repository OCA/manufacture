...
class TestQualityControl(TransactionCase):
    ...
    def setUp(self):
        ...
        self.val_ok = self.env.ref(
            'quality_control_oca.qc_test_question_value_1')
        self.val_ko = self.env.ref(
            'quality_control_oca.qc_test_question_value_2')
        self.qn_question = self.env.ref(
            'quality_control_oca.qc_test_question_2')

...
class TestQualityControlIssue(common.SingleTransactionCase):
    ...
    def setUpClass(cls):
        ...
        cls.group_qc_user = cls.env.ref("quality_control.group_quality_control_user")
        cls.group_user = cls.env.ref("base.group_user")
        cls.qc_user = cls._create_user(
            "qc_user", [cls.group_qc_user, cls.group_user], cls.company,
        )
        ...
        # Create QC Team
        cls.team = cls.qc_team_obj._get_default_qc_team_id(user_id=cls.qc_user.id)
    ...
    def test_01_create_qc_problem_group(self):
        ...
        self.assertEquals(
            ...
            1,
            "User 2 should have read access " "to all QC problem groups",
        )
    ...
    def test_02_create_qc_problem(self):
        ...
        self.assertEquals(
            len(qc_problem_list),
            2,
            "User 2 should have read access " "to all QC problem",
        )
    ...
    def test_05_create_qc_issue_stage(self):
        ...
        self.assertEquals(
            ...
            1,
            "User 2 should have read access " "to all QC stages",
        )
    ...
    def test_07_scrap_products(self):
        ...
        scrap = self.stock_scrap_obj.with_context(res.get("context", {})).create({})

        scrap.action_validate()
        qc_issue.action_view_stock_scrap()

        self.assertEquals(qc_issue.stock_scrap_qty, 1, "Scrap quantity should equal 1")

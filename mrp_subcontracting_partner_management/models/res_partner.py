...
class ResPartner(models.Model):
    ...
    def _update_subcontractor_values_name(self, name):
        ...
        field_names = [*self.CHECK_DATA, "property_stock_subcontractor"]
    ...
    def create(self, vals):
        ...
        if vals.get("is_subcontractor_partner") and vals.get("is_company"):
            values = {}
            for key, func in self.CHECK_DATA.items():
    ...
    def _update_subcontractor_entities_for_record(self, is_subcontractor_partner):
        ...
        data_items = self.CHECK_DATA.items()
        for rec in self:
            vals = {}

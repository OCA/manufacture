...
This module adds a new menu entry 'Bill of Materials Hierarchy' in
'Manufacturing | Products', from which the user can create a complete BOM
hierarchy from the tree view. The user can navigate from the tree view to
the child BOM's or to the product BOM's with a single click.

[![Runbot Status](https://runbot.odoo-community.org/runbot/badge/flat/129/12.0.svg)](https://runbot.odoo-community.org/runbot/repo/github-com-oca-manufacture-129)
[![Build Status](https://travis-ci.org/OCA/manufacture.svg?branch=12.0)](https://travis-ci.org/OCA/manufacture)
...
[base_repair](base_repair/) | 12.0.1.1.0 | [![marcelsavegnago](https://github.com/marcelsavegnago.png?size=30px)](https://github.com/marcelsavegnago) | This module extends the functionality of Odoo Repair module to add some basic features.
...
[mrp_multi_level](mrp_multi_level/) | 12.0.2.4.0 | [![JordiBForgeFlow](https://github.com/JordiBForgeFlow.png?size=30px)](https://github.com/JordiBForgeFlow) [![LoisRForgeFlow](https://github.com/LoisRForgeFlow.png?size=30px)](https://github.com/LoisRForgeFlow) | Adds an MRP Scheduler
...
[mrp_request_workcenter_cycle](mrp_request_workcenter_cycle/) | 12.0.1.0.0 | [![bealdav](https://github.com/bealdav.png?size=30px)](https://github.com/bealdav) | MRP Request Workcenter Cycle
...
[mrp_warehouse_calendar](mrp_warehouse_calendar/) | 12.0.1.0.1 | [![jbeficent](https://github.com/jbeficent.png?size=30px)](https://github.com/jbeficent) | Considers the warehouse calendars in manufacturing
...
[quality_control_team](quality_control_team/) | 12.0.1.1.0 | [![lreficent](https://github.com/lreficent.png?size=30px)](https://github.com/lreficent) | Adds quality control teams to handle different quality control workflows

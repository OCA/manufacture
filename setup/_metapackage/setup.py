...
setuptools.setup(
    ...
    install_requires=[
        ...
        'odoo-addon-mrp_bom_assign_auto>=15.0dev,<15.1dev',
        ...
        'odoo-addon-mrp_production_consumption_warning>=15.0dev,<15.1dev',
        ...
        'odoo-addon-mrp_workorder_ref>=15.0dev,<15.1dev',
